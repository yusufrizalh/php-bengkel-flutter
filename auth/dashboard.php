            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <span">
                                <img src="http://localhost/blog/auth/users/uploads/<?php echo $_SESSION['photo']; ?>" alt="profile-pic" class="img-fluid img-thumbnail rounded-circle mx-auto d-block" style="width: 250px; height: 250px">
                                </span>
